    ...
    <div id="main-wrapper">
      ...
      <div class="page-wrapper">
        ...
        <!--<div class="container-fluid">-->
          <!--&lt;!&ndash; ============================================================== &ndash;&gt;-->
          <!--&lt;!&ndash; Bread crumb and right sidebar toggle &ndash;&gt;-->
          <!--&lt;!&ndash; ============================================================== &ndash;&gt;-->
          ...
          <!--</div>-->
          <!--&lt;!&ndash; ============================================================== &ndash;&gt;-->
          <!--&lt;!&ndash; End Bread crumb and right sidebar toggle &ndash;&gt;-->
          <!--&lt;!&ndash; ============================================================== &ndash;&gt;-->
          <!--&lt;!&ndash; ============================================================== &ndash;&gt;-->
          <!--&lt;!&ndash; Start Page Content &ndash;&gt;-->
          <!--&lt;!&ndash; ============================================================== &ndash;&gt;-->
          <!--&lt;!&ndash; Row &ndash;&gt;-->
          <!--<div class="row">-->
            <!--&lt;!&ndash; Column &ndash;&gt;-->
          ...
          <!--<div class="row">-->
            ...
            <!--<div class="col-lg-4 col-xlg-3 col-md-5">-->
              <!--&lt;!&ndash; Column &ndash;&gt;-->
              <!--<div class="card">-->
                <!--<img class="card-img-top" src="../../static/images/background/profile-bg.jpg" alt="Card image cap">-->
                <!--<div class="card-block little-profile text-center">-->
                  <!--<div class="pro-img"><img src="../../static/images/users/4.jpg" alt="user" /></div>-->
                ...
                <!--<div class="card-block">-->
                  <!--<div class="message-box contact-box">-->
                    ...
                    <!--<div class="message-widget contact-widget">-->
                      <!--&lt;!&ndash; Message &ndash;&gt;-->
                      <!--<a href="#">-->
                        <!--<div class="user-img"> <img src="../../static/images/users/1.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>-->
                  ...
                  <!--<div class="tab-pane active" id="home" role="tabpanel">-->
                    <!--<div class="card-block">-->
                      <!--<div class="profiletimeline">-->
                        <!--<div class="sl-item">-->
                          <!--<div class="sl-left"> <img src="../../static/images/users/1.jpg" alt="user" class="img-circle"> </div>-->
                          <!--<div class="sl-right">-->
                            <!--<div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>-->
                              <!--<p>assign a new task <a href="#"> Design weblayout</a></p>-->
                              <!--<div class="row">-->
                                <!--<div class="col-lg-3 col-md-6 m-b-20"><img src="../../static/images/big/img1.jpg" alt="user" class="img-responsive radius"></div>-->
                                <!--<div class="col-lg-3 col-md-6 m-b-20"><img src="../../static/images/big/img2.jpg" alt="user" class="img-responsive radius"></div>-->
                                <!--<div class="col-lg-3 col-md-6 m-b-20"><img src="../../static/images/big/img3.jpg" alt="user" class="img-responsive radius"></div>-->
                                <!--<div class="col-lg-3 col-md-6 m-b-20"><img src="../../static/images/big/img4.jpg" alt="user" class="img-responsive radius"></div>-->
                              <!--</div>-->
                        ...
                        <!--<hr>-->
                        <!--<div class="sl-item">-->
                          <!--<div class="sl-left"> <img src="../../static/images/users/2.jpg" alt="user" class="img-circle"> </div>-->
                          <!--<div class="sl-right">-->
                            <!--<div> <a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>-->
                              <!--<div class="m-t-20 row">-->
                                <!--<div class="col-md-3 col-xs-12"><img src="../../static/images/big/img1.jpg" alt="user" class="img-responsive radius"></div>-->
                        ...
                        <!--<hr>-->
                        <!--<div class="sl-item">-->
                          <!--<div class="sl-left"> <img src="../../static/images/users/3.jpg" alt="user" class="img-circle"> </div>-->
                          <!--<div class="sl-right">-->
                            <!--<div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>-->
                        ...
                        <!--<hr>-->
                        <!--<div class="sl-item">-->
                          <!--<div class="sl-left"> <img src="../../static/images/users/4.jpg" alt="user" class="img-circle"> </div>-->
                          <!--<div class="sl-right">-->
                            <!--<div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>-->
